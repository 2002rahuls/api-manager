              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-dark-secondary p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-6 flex justify-end gap-2">
                    <button
                      type="button"
                      className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-dark-text bg-gray-100 dark:bg-dark-muted rounded-md hover:bg-gray-200 dark:hover:bg-dark-muted/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-500"
                      onClick={onClose}
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="px-4 py-2 text-sm font-medium text-white bg-purple-600 dark:bg-dark-accent rounded-md hover:bg-purple-700 dark:hover:bg-dark-accent/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-500"
                    >
                      Create
                    </button>
                  </div>
